...
const cases = [
  ...
  { id: "exact-boys-schedule", language: "roman-ur", messages: [{ role: "user", content: "Boys Class 9 Science Group A ki timing?" }], required: [/Monday|4:30/i, /Maths/i], action: "route", actionContains: "batch=b9sa" },
  { id: "contextual-schedule", language: "roman-ur", messages: [{ role: "user", content: "Class 9 Science ki timing?" }, { role: "assistant", content: "Boys ya Girls Campus?" }, { role: "user", content: "Boys Campus." }, { role: "assistant", content: "Group A ya B?" }, { role: "user", content: "Group A." }], required: [/Monday|4:30/i], action: "route", actionContains: "batch=b9sa" },
  { id: "girls-general-schedule", language: "en", messages: [{ role: "user", content: "Girls Campus Class 9 General schedule" }], required: [/Tuesday|3:00/i, /Maths/i], action: "route", actionContains: "batch=g9g" },
  ...
  { id: "campus-correction", language: "en", messages: [{ role: "user", content: "I need Boys Campus Class 9 Science timing." }, { role: "assistant", content: "Which group?" }, { role: "user", content: "Actually, correction: Girls Campus." }, { role: "assistant", content: "Noted." }, { role: "user", content: "What is the timing now?" }], required: [/Girls/i, /Monday|4:30/i], action: "route", actionContains: "batch=g9s" },
];
